...
const VerifyEmail = () => {
    ...
    const description = verificationMessage || (token
        ? t("verifyEmail.waitMessage")
        : t("verifyEmail.openLinkMessage"));
                    ...
                    <div className="bg-white rounded-[32px] shadow-[0_32px_64px_-12px_rgba(16,24,40,0.08)] border border-slate-100 overflow-hidden">
                        ...
                        <div className="px-8 pt-12 pb-10 sm:px-12 text-center">
                            ...
                            {!verifying && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    >
                                        {shouldShowLogin ? t("verifyEmail.continueLogin") : t("verifyEmail.backRegister")}
                                    </Link>
                            ...
                            {verifying && (
                                <div className="flex flex-col items-center gap-3">
                                    ...
                                    <span className="text-sm font-medium text-slate-400">{t("verifyEmail.securityCheck")}</span>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-slate-50/50 py-6 px-8 sm:px-12 border-t border-slate-100 text-center">
                            <p className="text-sm text-slate-400">
                                Rastriya Khadya Bank Mart &copy; {new Date().getFullYear()} • {t("verifyEmail.footerNote")}
                            </p>
                        </div>
                    </div>
